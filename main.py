...
def main(args):
    ...
    data_loader_val = DataLoader(dataset_val, args.valid_batch_size, sampler=sampler_val,
    ...
    if args.adjust_cost_class is not None:
        criterion.matcher.cost_class = args.adjust_cost_class
