...
class DETR(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_queries, num_attr=3, aux_loss=False):
        ...
        self.attr_embed = nn.Linear(hidden_dim, num_attr)
...
class SetCriterion(nn.Module):
    ...
    def loss_attrs(self, outputs, targets, indices, num_boxes, log=True):
        ...
        losses = {'loss_attrs': loss_ce}

        if log:
            # TODO this should probably be a separate loss, not hacked in this one here
            losses['attrs_error'] = 100 - accuracy(src_logits, target_classes_o)[0]
        return losses
